...
void app_slideshow_on_run(mini_app_inst_t *p_app_inst) {
    ...
    p_app_handle->p_slideshow_view = slideshow_view_create();
    ...
    slideshow_view_set_user_data(p_app_handle->p_slideshow_view, p_app_handle);
    mui_list_view_set_user_data(p_app_handle->p_list_view, p_app_handle);

    mui_view_dispatcher_add_view(p_app_handle->p_view_dispatcher, SLIDESHOW_VIEW_ID_MAIN, slideshow_view_get_view(p_app_handle->p_slideshow_view));
    ...
    mui_scene_dispatcher_set_scene_defines(p_app_handle->p_scene_dispatcher, slideshow_scene_defines,
                                           SLIDESHOW_SCENE_MAX);

    mui_scene_dispatcher_next_scene(p_app_handle->p_scene_dispatcher, SLIDESHOW_SCENE_MAIN);
}
